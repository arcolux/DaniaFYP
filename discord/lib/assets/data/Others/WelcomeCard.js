...
const { formatVariable, applyText, ordinalSuffix } = require("../../../../util/util").Util;
...
module.exports = class Greeting {
    ...
    async toAttachment() {
        ...
        const memberCount = this.textMemberCount.replace(/{count}/g, ordinalSuffix(this.memberCount));
